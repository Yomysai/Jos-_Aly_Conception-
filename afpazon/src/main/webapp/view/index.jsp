						...
						<div class="row">
								...
								<div class="thumb-wrapper">
									...
									<div class="thumb-content">
										...
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											elit. Nam eu sem tempor, varius quam.</p>
							...
							<div class="col-sm-4">
								<div class="thumb-wrapper">
									...
									<div class="thumb-content">
										<h4>New York</h4>
										<p>Vivamus fermentum in arcu in aliquam. Quisque aliqua
											porta odio in fringilla vivamus.</p>
										<a href="#" class="btn btn-primary">More <i
											class="fa fa-angle-right"></i></a>
									</div>
								</div>
							...
							<div class="col-sm-4">
								<div class="thumb-wrapper">
									...
									<div class="thumb-content">
										<h4>Paris</h4>
										<p>Convallis eget pretium eu, bibendum non leo. Proin susc
											ipit purus adipiscing dolor.</p>
										<a href="#" class="btn btn-primary">More <i
											class="fa fa-angle-right"></i></a>
									</div>
								</div>
